...
import 'package:jobsque/presentation/widgets/notification_settings_item.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 4.h,),
            TwoStepVerificationTile(icon: Iconsax.sms, text: "Two-step verification provides additional security by asking for a verification code every time you log in on another device."),
            SizedBox(height: 2.h,),
            TwoStepVerificationTile(icon: Iconsax.external_drive, text: "Adding a phone number or using an authenticator will help keep your account safe from harm."),
